...
Your task is to construct a confidence interval for the average annual delta since 2011. Recall that the dataframe `comparison` has already grouped temperature anomalies according to time intervals; we are only interested in what is happening  between 2011-present as a whole interval and not on a year-by-year basos
