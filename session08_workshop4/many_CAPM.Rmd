...
```{r get_price_data_sp500, message=FALSE, warning=FALSE, cache=TRUE, eval=FALSE}
...
```{r load_price_data_sp500, message=FALSE, warning=FALSE, cache=TRUE}
# use this file that has the downloaded data
sp500_stocks <- vroom::vroom(here::here("data/sp500_stocks.csv.zip"))
```
...
# save file with stock data, that you could read using vroom::vroom() rather than downloading
